...
class PaymentModule extends PaymentModuleCore
{
    ...
    /**
     * Overrideb to provide Free Shipping for sample products
     */
    /**
...
//Tools::dieObject(['$delivery_option_list' => $delivery_option_list, '$package_list' => $package_list, '$cart_delivery_option' => $cart_delivery_option]);
            ...
            foreach ($package_list as $id_address => $packageByAddress) {
                foreach ($packageByAddress as $id_package => $package) {
                    ...
                    if (!$this->context->cart->isVirtualCart() && isset($package['id_carrier'])) {
                        // wksample
                        // set sample carrier to sample package
                        if($package['sample_package']) {
                            $package['id_carrier'] = $this->context->cart->getSampleCarrierId();
                        }
