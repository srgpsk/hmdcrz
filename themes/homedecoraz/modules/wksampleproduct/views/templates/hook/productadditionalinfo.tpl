...
{*    <p class="sample-description">{if $sample.description}{$sample.description|escape:'htmlall':'UTF-8'}{else}Try 5 samples for $5<br>Free shipping for samples.{/if}</p>*}
