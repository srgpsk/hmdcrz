...
{if $products}
    {if !$refresh}
        ...
        <a id="hideSendWishlist" class="button_account icon"  href="#" onclick="WishlistVisibility('wishlistLinkTop', 'SendWishlist'); return false;" title="{l s='Close this wishlist' mod='blockwishlist'}">
