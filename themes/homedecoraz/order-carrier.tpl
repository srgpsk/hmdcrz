...
{else}
	<div id="carrier_area" class="opc-main-block">
		<h1 class="page-heading step-num">{l s='Shipping'}</h1>
	...
	{else}
		...
		{else}
			...
			<div class="delivery_options_address">
				...
				{if $opc}
					<p class="carrier_title">{l s='Comments:'}</p>
					<div>
						<p>{l s='Please add any additional info about your order in the field below.'}</p>
			...
			{if $conditions AND $cms_id}
				...
				<p class="checkbox">
					...
					<a href="{$link_conditions|escape:'html':'UTF-8'}" class="iframe">{l s='(Read the Terms of Service)'}</a>
				</p>
			{/if}
		</div> <!-- end delivery_options_address -->
		{if !$opc}
